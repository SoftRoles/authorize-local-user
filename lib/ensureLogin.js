 ...
 *   - `grantLocalAs`   always grant local requests as {username:'local'} 
 * 
 * Examples:
 *
 *     app.get('/profile',
 ...
 *
 *     app.get('/profile',
 *       ensureLoggedIn({redirectTo:'/login', grantLocal: true}),
 *       function(req, res) { ... });
 *
 *     app.get('/profile',
...
module.exports = function ensureLogin(options) {
  ...
  return function (req, res, next) {
    var localUser = req.ip.indexOf("127.0.0.1") > -1 && options.grantLocalAs
